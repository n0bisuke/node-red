                ...
                connections[id] = function() {
                    ...
                    var setupSerial = function() {
                        ...
                        obj.serial.on('error', function(err) {
                                console.log("[serial] serial port "+port+" error "+err);
                        ...
                        obj.serial.on('close', function() {
                                if (!obj._closing) {
                                    console.log("[serial] serial port "+port+" closed unexpectedly");
                                    obj.tout = setTimeout(function() {
                                            setupSerial();
                                    },settings.serialReconnectTime);
                                }
                        ...
                        obj.serial.on('open',function() {
                                console.log("[serial] serial port "+port+" opened at "+baud+" baud");
                                obj.serial.flush();
