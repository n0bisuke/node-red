        ...
        if (!connections[id]) {
            connections[id] = function() {
                ...
                client.on('connect',function() {
                        ...
                        console.log('[mqtt] connected to broker tcp://'+broker+':'+port);
                ...
                client.on('connectionlost', function(err) {
                        console.log('[mqtt] connection lost to broker tcp://'+broker+':'+port);
                        setTimeout(function() {
                                if (client) {
                                    client.connect(options);
                                }
                ...
                client.on('disconnect', function() {
                        console.log('[mqtt] disconnected from broker tcp://'+broker+':'+port);
                });
